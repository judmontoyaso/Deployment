...
const MobileStock = () => {
  ...
  const saveFile = () => {
    //Para obtener archivos pdf, se obtiene un link de archivo codificado en base 64 y descargarlo como pdf... pdf en base
    saveAs(
  ...
  if (loading)
    return "Obteniendo empresas de la base de datos, por favor espere...";
      ...
      <LayoutDot>
        ...
        <section className="contenedorMobile mt-20 m-auto flex flex-col">
          ...
          <section className="botonesControl align-middle justify-center flex">
            ...
            <span className="text-gray-500  text-lg align-middle pl-10 pr-10  ">
              {" "}
                ...
                {(props) => {
                  return (
                    <form onSubmit={props.handleSubmit} id="Formulario">
                      ...
                      <section className="contenedorLogoEmpresaMobile flex ml-6 mt-20">
                        {" "}
                        <Image
                      ...
                      <section className="m-auto flex flex-col">
                        ...
                        <section>
                          <input
                            className="border-opacity-50 m-10 mt-3 border-b-2 border-gray-500 font-bold bg-white bg-white
                "
                            id="nombre"
                            disabled
                        ...
                        <section>
                          <input
                            className="border-opacity-50 m-10 mt-3  border-b-2 border-gray-500 font-bold bg-white"
                            id="razonSocial"
                            disabled
            ...
            <section className="flex items-center flex-col descargas -mt-16 -mb-16">
              ...
              <section className="items-center  mb-6">
                <button onClick={saveFile}>
                  <span className="align-middle mr-10 text-sm text-sm">
              ...
              <section className="items-center mb-6">
                <button onClick={saveFile}>
                  <span className="align-middle mr-10 text-sm">
